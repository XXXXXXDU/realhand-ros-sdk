#!/usr/bin/env python
#This demo is for the worm gear version of the L10 dexterous hand. It supports the left hand by default. To support the right hand, change cb_left_hand_control_cmd to cb_right_hand_control_cmd
...
def show_left():
    ...
    if(show_count>=show_count_obj):
        ...
        if(show_step==0):
            ...
            hand['joint4'] = 100
            return list(hand.values())
        elif(show_step==11): #// Bend and straighten middle and index alternately twice
            show_step=show_step+1
            show_count_obj = 15
            hand['joint3'] = 250
            hand['joint4'] = 250
